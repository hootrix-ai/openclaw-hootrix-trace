...
export declare function mapUsageToOpikTokens(usage: Record<string, unknown> | undefined): Record<string, number> | undefined;
export declare function mergeDefinedConfig(base: OpikPluginConfig, override: OpikPluginConfig): OpikPluginConfig;
...
export declare function resetOpikThreadSessionAliases(): void;
/**
 * Prefer canonical `agent:…` thread id; remember volatile run session UUID → canonical for hooks that
 * only carry `sessionId`.
 */
export declare function resolveEffectiveOpikSessionKey(ctx: Record<string, unknown>, eventSessionId?: string): string | undefined;
