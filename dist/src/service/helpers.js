...
export function mapUsageToHootrixTokens(usage) {
    if (!usage)
        return undefined;
    const mapped = {};
    if (usage.input != null)
...
export function resetHootrixThreadSessionAliases() {
 ...
 */
export function resolveEffectiveHootrixSessionKey(ctx, eventSessionId) {
