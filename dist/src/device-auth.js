...
const LOCAL_MAIN_API_CANDIDATES = ["http://127.0.0.1:9821", "http://localhost:9821"];
...
export async function resolveMainApiUrlAsync(fetchImpl = fetch) {
...
export function resolveMainSiteUrl(mainApiUrl) {
...
export function buildConnectUrl(sessionId, mainApiUrl, backendConnectUrl) {
...
async function probeMainApi(baseUrl, fetchImpl) {
    try {
