...
function buildErrorResponse(error: unknown, url: string): Response {
 ...
 */
export async function collectorFetch(input: RequestInfo | URL, init?: RequestInit): Promise<Response> {
