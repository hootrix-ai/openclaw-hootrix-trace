...
export const MEDIA_REF_PLACEHOLDER_RE =
  /\[(media-ref:[a-f0-9]{16}:[^\]]+)\]/gi;
...
export function parseMediaRefPlaceholder(token: string): ParsedMediaRef | undefined {
...
export function collectMediaRefsFromString(value: string, target: Set<ParsedMediaRef>): void {
...
export function collectMediaRefsFromUnknown(value: unknown, target: Set<ParsedMediaRef>): void {
...
export function mediaRefDedupeKey(parsed: ParsedMediaRef): string {
